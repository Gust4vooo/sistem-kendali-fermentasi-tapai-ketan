...
void setup() {
  ...
  // 3 MF input Error
  FuzzySet* errorNegatif = new FuzzySet(-5, -5, -4, 0); 
  FuzzySet* errorNol     = new FuzzySet(-4, 0, 0, 4);   
  FuzzySet* errorPositif = new FuzzySet(0, 4, 8, 8); 
  ...
  FuzzySet* DE_Negatif = new FuzzySet(-5, -5, -2, 0);
  FuzzySet* DE_Nol     = new FuzzySet(-2, 0, 0, 2);
  FuzzySet* DE_Positif = new FuzzySet(0, 2, 3, 3);
