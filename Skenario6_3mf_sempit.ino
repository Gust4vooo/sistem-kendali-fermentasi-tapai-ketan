...
void setup() {
  ...
  // 3 MF input Error
  FuzzySet* errorNegatif = new FuzzySet(-5, -5, -1, 0); 
  FuzzySet* errorNol     = new FuzzySet(-1, 0, 0, 1);   
  FuzzySet* errorPositif = new FuzzySet(0, 1, 8, 8); 
  ...
  FuzzySet* DE_Negatif = new FuzzySet(-5, -5, -0.5, 0);
  FuzzySet* DE_Nol     = new FuzzySet(-0.5, 0, 0, 0.5);
  FuzzySet* DE_Positif = new FuzzySet(0, 0.5, 3, 3);
